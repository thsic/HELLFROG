function data_player_parameter_default() {
	...
	data_set_player_bullet(ePB_type.BulletRed, 20, 20, 0.3, 0.92, 6, 20, 3, fire_straight_ammo, 3);
	data_set_player_bullet(ePB_type.BulletYellow, 17, 13, 0.3, 0.9, 70, 8, 10, fire_spread_ammo, 2);
	...
	data_set_hookshot(eHK_type.normal_hook, 90, 30, 10, 5, 1, 16, 24, 1, 10, 2);
