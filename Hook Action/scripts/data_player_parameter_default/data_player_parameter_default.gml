...
data_set_player_bullet(ePB_type.BulletRed, 20, 20, 0.3, 0.92, 6, 50, 3, fire_straight_ammo);
data_set_player_bullet(ePB_type.BulletYellow, 17, 13, 0.3, 0.9, 70, 20, 10, fire_spread_ammo);
