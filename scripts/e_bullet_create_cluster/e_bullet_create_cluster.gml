function e_bullet_create_cluster(_object_number, _bullet_speed, _bullet_direction, _life_time, _animation_curve, _enemy_id, _cluster_amount, _cluster_dir_max, _cluster_dir_min){
