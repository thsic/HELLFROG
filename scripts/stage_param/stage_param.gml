...
_ds[# STAGENAME.HELLCAVE1, STAGEPARAM.STAGETYPE] = STAGETYPE.TEST;
...
_ds2[# STAGETYPE.HELLFOREST, STAGEPARAM.STAGECOLOR] = "";
...
_ds2[# STAGETYPE.TUTORIAL, STAGEPARAM.STAGECOLOR] = "";
