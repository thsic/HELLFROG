...
#region hellforest
_ds[# STAGENAME.HELLCAVE1, STAGEPARAM.STAGEID] = r_stage6;
_ds[# STAGENAME.HELLCAVE1, STAGEPARAM.NEXTSTAGE] = r_stage7;
_ds[# STAGENAME.HELLCAVE1, STAGEPARAM.STAGENUM] = 1;
_ds[# STAGENAME.HELLCAVE1, STAGEPARAM.STAGETYPE] = STAGETYPE.HELLFOREST;

_ds[# STAGENAME.HELLCAVE2, STAGEPARAM.STAGEID] = r_stage7;
_ds[# STAGENAME.HELLCAVE2, STAGEPARAM.NEXTSTAGE] = r_stage8;
_ds[# STAGENAME.HELLCAVE2, STAGEPARAM.STAGENUM] = 2;
_ds[# STAGENAME.HELLCAVE2, STAGEPARAM.STAGETYPE] = STAGETYPE.HELLFOREST;

_ds[# STAGENAME.HELLCAVE3, STAGEPARAM.STAGEID] = r_stage8;
_ds[# STAGENAME.HELLCAVE3, STAGEPARAM.NEXTSTAGE] = r_stage9;
_ds[# STAGENAME.HELLCAVE3, STAGEPARAM.STAGENUM] = 3;
_ds[# STAGENAME.HELLCAVE3, STAGEPARAM.STAGETYPE] = STAGETYPE.HELLFOREST;

_ds[# STAGENAME.HELLCAVE4, STAGEPARAM.STAGEID] = r_stage9;
_ds[# STAGENAME.HELLCAVE4, STAGEPARAM.NEXTSTAGE] = r_stage10;
_ds[# STAGENAME.HELLCAVE4, STAGEPARAM.STAGENUM] = 4;
_ds[# STAGENAME.HELLCAVE4, STAGEPARAM.STAGETYPE] = STAGETYPE.HELLFOREST;

_ds[# STAGENAME.HELLCAVE5, STAGEPARAM.STAGEID] = r_stage10;
_ds[# STAGENAME.HELLCAVE5, STAGEPARAM.NEXTSTAGE] = r_tutorial2;
_ds[# STAGENAME.HELLCAVE5, STAGEPARAM.STAGENUM] = 5;
_ds[# STAGENAME.HELLCAVE5, STAGEPARAM.STAGETYPE] = STAGETYPE.HELLFOREST;
#endregion

#region helllake
_ds[# STAGENAME.HELLCAVE5, STAGEPARAM.STAGEID] = r_stage11;
_ds[# STAGENAME.HELLCAVE5, STAGEPARAM.NEXTSTAGE] = r_stage12;
_ds[# STAGENAME.HELLCAVE5, STAGEPARAM.STAGENUM] = 1;
_ds[# STAGENAME.HELLCAVE5, STAGEPARAM.STAGETYPE] = STAGETYPE.HELLLAKE;

_ds[# STAGENAME.HELLCAVE5, STAGEPARAM.STAGEID] = r_stage12;
_ds[# STAGENAME.HELLCAVE5, STAGEPARAM.NEXTSTAGE] = r_stage13;
_ds[# STAGENAME.HELLCAVE5, STAGEPARAM.STAGENUM] = 2;
_ds[# STAGENAME.HELLCAVE5, STAGEPARAM.STAGETYPE] = STAGETYPE.HELLLAKE;
#endregion
...
_ds2[# STAGETYPE.HELLLAKE, STAGEPARAM.STAGECOLOR] = "";
...
_ds2[# STAGETYPE.HELLMOUNTAIN, STAGEPARAM.STAGECOLOR] = "";
