...
/*if(follow != noone){
	var _view_direction = point_direction(GAMESCREEN_HSIZE/2, GAMESCREEN_WSIZE/2, mouse_x, mouse_y);//照準向いている方向
	var _view_distance = point_distance(GAMESCREEN_HSIZE/2, GAMESCREEN_WSIZE/2, mouse_x, mouse_y)//中心からどれだけ離れているか
...
x += (xTo - x) / 16;
y += (yTo - y) / 16;
debug_draw_circle(xTo, yTo, 5, false, c_white, 3)*/
